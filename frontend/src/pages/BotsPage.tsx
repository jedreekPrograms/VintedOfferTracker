...
function BotsPage() {
        ...
        useCallback(
            async () => {
                ...
                try {
                    ...
                    const loadedQuotaByBotId:
                        Record<number, BotOfferQuota> =
                        {};
    ...
    return (
        <section className="page">
            ...
            <header
                className="page-header bots-page-header"
            >
...
function BotOfferQuotaCell({
    quota,
}: BotOfferQuotaCellProps) {
    ...
    return (
        <div className="bot-quota-cell">
            ...
            <progress
                ...
                aria-label={
                    `Wykorzystano ${quota.used} z ${quota.limit} ofert`
                }
            />
