...
function AppLayout() {
    ...
    return (
        <div className="app-layout">
            ...
            <button
                className={`mobile-navigation-backdrop ${isNavigationOpen ? "mobile-navigation-backdrop-visible" : ""}`}
                type="button"
            ...
            <nav className="mobile-bottom-navigation" aria-label="Szybka nawigacja">
                ...
                <button
                    className={`mobile-bottom-link mobile-bottom-more ${isNavigationOpen ? "mobile-bottom-link-active" : ""}`}
                    type="button"
                    aria-label="Więcej ekranów"
                    onClick={() => setIsNavigationOpen(true)}
                >
