...
public class PasswordEncryptionConverter
    ...
    private static final int AES_KEY_LENGTH_BYTES =
            32;
    ...
    public String convertToEntityAttribute(
        ...
        /*
         * Tymczasowa kompatybilność ze starymi rekordami.
         *
         * Obecne hasła są jeszcze zapisane plaintextem.
         * Dzięki temu po dodaniu szyfrowania aplikacja
         * nadal będzie mogła je odczytać.
         *
         * W następnym kroku zaszyfrujemy stare rekordy.
         */
        if (
