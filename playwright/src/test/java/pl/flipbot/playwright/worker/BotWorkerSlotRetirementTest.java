...
public class BotWorkerSlotRetirementTest {
    ...
    public void idleSlotStopsAfterGracefulRetirementRequest() throws Exception {
        ...
        BotRunScheduler scheduler = new PollOnlyScheduler(config(), telemetry, pollEntered);
        BotWorkerSlot slot = new BotWorkerSlot(7, scheduler, config(), telemetry);
        ...
        try {
            ...
            assertFalse("retirement request must be idempotent", slot.requestRetirement());
