...
final class OneTrustConsentGuard {
    ...
    private static final String SCRIPT = """
            (() => {
                ...
                // OneTrust can attach handlers or open the preference center
                // without a useful DOM mutation for our observer. Poll briefly
                // as a second line of defence. A new document gets a fresh init
                // script, so this does not need to run forever.
